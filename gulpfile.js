...
function watchFiles() {
  ...
  gulp.watch("./icomoon/*.css",icomoon)
}

function icomoon(){
  var icomoon = gulp.src('./icomoon/**/*')
  .pipe(gulp.dest('./vendor/icomoon/'))
  return merge(icomoon)
}
...
function distFolder(){
  ...
  .pipe(gulp.dest('./dist/'));
  var css = gulp.src('./css/*.min.css')
  .pipe(gulp.dest('./dist/css/'));
  var js =  gulp.src('./js/*.min.js')
  .pipe(gulp.dest('./dist/js/'));
  var vendor =  gulp.src('./vendor/**/*')
  .pipe(gulp.dest('./dist/vendor'));
  var icomoon = gulp.src('./icomoon/**/*')
  .pipe(gulp.dest('./dist/vendor/icomoon/'))
  return merge(html,css,js,vendor,icomoon)
}
